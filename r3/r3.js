...
let img = new Image();
img.src = "r3assets/jcbike.png";

Player.prototype.draw = function() {
  // InfiniteRunner.fillStyle = this.color;
  // var pattern = InfiniteRunner.createPattern(img, "no-repeat");
  // InfiniteRunner.fillStyle = pattern;
  
  // InfiniteRunner.fillRect(this.x, this.y, this.width, this.height);
  InfiniteRunner.drawImage(img, this.x, this.y, this.width, this.height);
...
InfiniteRunner.setup = function () {
  ...
  this.player = new Player({x: 150, y: 30, width: 84, height: 84});
